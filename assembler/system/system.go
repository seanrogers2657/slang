...
// SystemAssembler is a concrete implementation of Assembler that uses system tools (as, ld)
...
// Assemble converts an assembly file (.s) to an object file (.o) using the system assembler
...
// Link creates an executable from object files using the system linker
...
func (a *SystemAssembler) Build(assembly string, opts assembler.BuildOptions) error {
	// Set defaults
